...
class LinearFusion(nn.Module):
    def __init__(self, ratio, img_size=320, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
                 num_heads=[1, 2, 4, 8], mlp_ratios=[4, 4, 4, 4], qkv_bias=False, qk_scale=None, drop_rate=0.,
                 attn_drop_rate=0., drop_path_rate=0., norm_layer=LayerNormParallel,
                 depths=[3, 4, 6, 3], sr_ratios=[8, 4, 2, 1]):
        super().__init__()
...
class linear_tf(LinearFusion):
    def __init__(self, ratio, img_size=320, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512], num_heads=[1, 2, 4, 8], mlp_ratios=[4, 4, 4, 4], qkv_bias=False, qk_scale=None, drop_rate=0, attn_drop_rate=0, drop_path_rate=0, norm_layer=LayerNormParallel, depths=[3, 4, 6, 3], sr_ratios=[8, 4, 2, 1]):
        super(linear_tf,self).__init__(
            ratio=ratio,  
            patch_size=patch_size,  
            embed_dims=embed_dims, 
            num_heads=num_heads, mlp_ratios=mlp_ratios, 
            qkv_bias=True,  
            drop_rate=drop_rate,  
...
class mit_b0(MixVisionTransformer):
    def __init__(self, ratio, **kwargs):
        super(mit_b0, self).__init__(ratio = ratio,
...
class mit_b1(MixVisionTransformer):
    def __init__(self, ratio, **kwargs):
        super(mit_b1, self).__init__(ratio = ratio,
...
class mit_b2(MixVisionTransformer):
    def __init__(self, ratio, **kwargs):
        super(mit_b2, self).__init__(ratio = ratio,
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
class mit_b3(MixVisionTransformer):
    def __init__(self, ratio, **kwargs):
        super(mit_b3, self).__init__(ratio = ratio,
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
class mit_b4(MixVisionTransformer):
    def __init__(self, ratio, **kwargs):
        super(mit_b4, self).__init__(ratio = ratio,
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
class mit_b5(MixVisionTransformer):
    def __init__(self, ratio, **kwargs):
        super(mit_b5, self).__init__(ratio = ratio,
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
